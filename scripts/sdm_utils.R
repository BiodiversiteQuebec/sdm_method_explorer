...
write_preds <- function(preds){
  filename <- paste(params$group, gsub(" ","_",params$species), params$model, params$years, params$period, params$dates, params$algorithm, params$usepredictors, params$bias,params$spatial,sep="_") |> paste0(".tif")
